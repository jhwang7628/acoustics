 ...
 * -------------------------------------------------------------------------------------
 *
 *       Filename:  DemoDropObjsWithFixed.cpp
 *
 *        Version:  1.0
 *        Created:  01/06/12 01:24:40
 *       Revision:  none
 ...
 * =====================================================================================
 */
#include "DemoDropObjsWithFixed.h"
...
// ----------------------------------------------------------------------------
DemoDropObjsWithFixed::DemoDropObjsWithFixed(
        const char* file, QGLViewer* canvas):canvas_(canvas)
{
...
int DemoDropObjsWithFixed::start()
{
    double tm;
    do {
        rsim_.begin_advance();
...
int DemoDropObjsWithFixed::step()
{
    PRINT_WARNING("step() is not supported\n");
    return 0;
}

void DemoDropObjsWithFixed::draw()
{
