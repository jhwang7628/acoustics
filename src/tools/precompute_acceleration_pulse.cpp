...
#include <wavesolver/viewer/WaveViewer.h>
...
static VEC3F                 ACCELERATION_DIRECTIONS[] = {
                                                  VEC3F( 1.0, 0.0, 0.0 ),
                                                  VEC3F( 0.0, 1.0, 0.0 ),
                                                  VEC3F( 0.0, 0.0, 1.0 ),
                                                  VEC3F( 1.0, 0.0, 0.0 ),
...
static VEC3F                 CENTER_OF_MASS( 0.0, 0.0, 0.0 );

static REAL                  PULSE_HALF_PERIOD = 0.0;

bool                         ZERO_BC = true;

REAL boundaryEval( const VEC3F &x, const VEC3F &n, int obj_id, REAL t,
...
void buildPulseApproximation( const vector<vector<FloatArray> > &waveOutput,
                              ...
                              VEC3F fieldCenter, REAL fieldRadius )
{
#if 0
