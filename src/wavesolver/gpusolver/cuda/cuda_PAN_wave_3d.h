...
Number_t pan_wave_sim_get_x(const Cuda_PAN_Wave_3d_t wave, int j);
Number_t pan_wave_sim_get_y(const Cuda_PAN_Wave_3d_t wave, int i);
Number_t pan_wave_sim_get_z(const Cuda_PAN_Wave_3d_t wave, int k);
