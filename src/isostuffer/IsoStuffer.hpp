...
#ifdef USE_HASH_MAP
        __gnu_cxx::hash_map< int, __gnu_cxx::hash_set<int> >            crossSet_;
        /*
         * map pair of vertex id into the id of cutting points in vtx_
         */
        __gnu_cxx::hash_map< int, __gnu_cxx::hash_map<int, int> >           cuttingPts_;
#else
