...
#include "../../../../../../../../../media/jui-hsien/General/Research/gpu-wavesolver-repo/acoustics/src/ui/IsoStufferFrame.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_IsoStufferFrame_t, stringdata) + ofs \
...
const QMetaObject IsoStufferFrame::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_IsoStufferFrame.data,
      qt_meta_data_IsoStufferFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IsoStufferFrame.stringdata))
        return static_cast<void*>(const_cast< IsoStufferFrame*>(this));
